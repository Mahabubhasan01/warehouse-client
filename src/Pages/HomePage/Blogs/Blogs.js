        ...
        <div class="card-body text-dark">
          ...
          <p class="card-text">
            ...
            <ul>
                ...
                <li> Javascript run any browser and also its new version is ES6</li>
                <li> Javascript most using framework React,Angular,Vue,Next,Electron and so more</li>
            ...
            <ul>
                ...
                <li> Node js is runtime env for js and also use specific for js</li>
            </ul>
          </p>
        </div>
      </div>
      <div class="card border-secondary mb-3 col-12 col-sm-6 col-md-4 col-lg-4 my-3 mx-0 " >
        ...
        <div class="card-body text-secondary">
          ...
          <p class="card-text">
            ...
            <ol>
                ...
                <li> You can use any interection or store data and using python C++ C# so more</li>
                <li> Mongodb has CRUD operation like you cand date create delete update and also read </li>
                <li>MongoDB stores JSON documents in collections with dynamic schemas</li>
                <li>Mongodb scales easily with no downtime, and without changing your application.</li>
            </ol>
              <h1 className="text-center text-info">Node Js</h1>
            <ul>
                <ol>It is runtime scalable and stressless js runtime env</ol>
                <li> User can easily interact without trouble </li>
                <li> Node js have very popuplar framework express which connect and front and backend without any trouble</li>
                <li> Node js all you have npm like node package manager you can do anything</li>
                <li> You do not follow hyper rule regulation stores data</li>
                <li> Overall user satisfiction scalable env</li>
            </ul>
          </p>
        </div>
      </div>
      <div class="card border-success mb-3 col-12 col-sm-6 col-md-4 col-lg-4 my-3 mx-0 " >
        ...
        <div class="card-body text-success">
          ...
          <p class="card-text">
            ...
            <ul>
                ...
                <li> Its not follow table or row and column you can freedom way store data </li>
                <li> Node js all you have npm like node package manager you can do anything</li>
